...
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data */ "./src/modules/data.js");
/* harmony import */ var _project_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./project-controller */ "./src/modules/project-controller.js");
...
var controller = new _project_controller__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  _createClass(UI, null, [{
    ...
    value: function initLoad() {
      ...
      if (!localStorage.getItem('todos')) {
        var inbox = new _project__WEBPACK_IMPORTED_MODULE_3__["default"]('Inbox');
        var completedTasks = new _project__WEBPACK_IMPORTED_MODULE_3__["default"]('Completed Tasks');
    ...
    value: function loadData() {
      controller = _data__WEBPACK_IMPORTED_MODULE_5__["default"].loadData(localStorage.getItem('todos'), localStorage.getItem('projects'));
      currentProject = controller.getProject('Inbox');
    }
  }, {
    key: "saveData",
    value: function saveData() {
      localStorage.setItem('projects', _data__WEBPACK_IMPORTED_MODULE_5__["default"].getSaveState(controller)[1]);
      localStorage.setItem('todos', JSON.stringify(_data__WEBPACK_IMPORTED_MODULE_5__["default"].getSaveState(controller)[0]));
    }
  }, {
    key: "showNavbar",
    value: function showNavbar() {
      ...
      addProjectBtn.addEventListener('click', function () {
        var checkForContainer = document.querySelectorAll('.add-project');
        ...
        if (checkForContainer.length < 1) {
          ...
          var addProjectConfirmBtn = document.createElement('button');
          ...
          addProjectConfirmBtn.addEventListener('click', function () {
            ...
            if (addProjectInput.value === "") {
              ...
              var addProjectError = document.createElement('div');
              ...
              var _addProjectError = document.createElement('div');

              _addProjectError.classList.add('error-msg');

              _addProjectError.textContent = "Project name must be less than 20 characters!";
              nav.appendChild(_addProjectError);
            } else if (UI.addProjectIsValid(addProjectInput.value) === true) {
              var tempProject = new _project__WEBPACK_IMPORTED_MODULE_3__["default"](addProjectInput.value);
              ...
              var _addProjectError2 = document.createElement('div');

              _addProjectError2.classList.add('error-msg');

              _addProjectError2.textContent = "Name already in use, try again!";
              nav.appendChild(_addProjectError2);
            }
          });
          addProjectContainer.appendChild(addProjectConfirmBtn);
          var addProjectCancelBtn = document.createElement('button');
    ...
    value: function refreshNavbar() {
      UI.hideNavbar();
      UI.showNavbar();
      var header = document.querySelector('.header-fullscreen');
      header.classList.remove('header-fullscreen');
      header.classList.add('header');
    }
  }, {
    key: "getNavState",
    value: function getNavState() {
      var heading = document.querySelector('header');
    ...
    value: function showHeader() {
      ...
      menuImg.addEventListener('click', function () {
        if (clicks % 2 === 0) {
          ...
          var _tasks = document.querySelector('.tasks-fullscreen');

          header.classList.remove('header-fullscreen');
          header.classList.add('header');

          _tasks.classList.remove('tasks-fullscreen');

          _tasks.classList.add('tasks');
    ...
    value: function setupContent() {
      ...
      addTaskBtn.addEventListener('click', function () {
        var taskContainers = document.querySelectorAll('.add-todo-form');
    ...
    key: "showTasks",
    value: function showTasks(project) {
      ...
      project.getTodos().forEach(function (task) {
        var taskContainer = document.createElement('div');
        taskContainer.classList.add('task-container');
        var taskContainerLeft = document.createElement('div');
        taskContainerLeft.classList.add('task-container-left');
        var taskContainerRight = document.createElement('div');
    ...
    value: function clearTasks() {
      ...
      var projectHeading = document.querySelector('.tasks h1');
    ...
    value: function editTask(task) {
      ...
      var todoEditForm = document.createElement('div');
    ...
    key: "createAddTodoForm",
    value: function createAddTodoForm() {
      var tasks = document.querySelector('.tasks');
      ...
      confirmButton.addEventListener('click', function () {
        ...
        if (titleInput.value === "") {
          ...
          var tempTitle = titleInput.value;
          var tempDate = dateInput.value;
          var tempTodo = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"](tempTitle, '', tempDate, '');
    ...
    key: "deleteAddTodoForm",
    value: function deleteAddTodoForm() {
      var tasks = document.querySelector('.tasks');
      var taskForm = document.querySelectorAll('.add-todo-form');
    ...
    key: "deleteEditTodoForm",
    value: function deleteEditTodoForm() {
      var content = document.querySelector('.content');
      var editTodoContainer = document.querySelector('.edit-container');
    ...
    key: "addTodo",
    value: function addTodo(todo, project) {
      project.addTodo(todo);
    }
  }, {
    key: "addProjectIsValid",
    value: function addProjectIsValid(name) {
    ...
    key: "addDemoTodos",
    value: function addDemoTodos(inbox) {
      var demoTodo1 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Create a new todo by clicking the Add Task button!', '', '2022-04-14', 'High');
      var demoTodo2 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Change the sort style by clicking the Sort by.. button!', '', '2022-04-16', 'Low');
      var demoTodo3 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Create a new project!', '', '2022-05-25', 'N/A');
      var demoTodo4 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Try deleting a project!', '', '2022-06-28', 'Low');
      var demoTodo5 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Reset your local storage to start afresh!!', '', '2023-11-11', 'Medium');
      var demoTodo6 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Click the checkbox on a task to tick it off!', '', '2022-04-18', 'High');
      var demoTodo7 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Check the completed tasks after ticking off a task!', '', '2022-04-24', 'Low');
      var demoTodo8 = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"]('Try editing a task!', '', '2022-12-25', 'High');
...
/* harmony export */ });
/* harmony import */ var _project_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project-controller */ "./src/modules/project-controller.js");
...
var data = /*#__PURE__*/function () {
  ...
  _createClass(data, null, [{
    key: "loadData",
    value: function loadData(todos, projectNames) {
      var controller = new _project_controller__WEBPACK_IMPORTED_MODULE_0__["default"]();
      todos = JSON.parse(todos);
      projectNames = projectNames.split(',');
      projectNames.forEach(function (name) {
        var tempProject = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](name);
        controller.addProject(tempProject);
        todos.forEach(function (todo) {
          if (todo.project === name) {
            if (todo.dueDate === 'Today') {
              var tempTodo = new _todo__WEBPACK_IMPORTED_MODULE_2__["default"](todo.title, todo.description, '2022-03-24', todo.priority);
            } else if (todo.dueDate === 'Tomorrow') {
              var tempTodo = new _todo__WEBPACK_IMPORTED_MODULE_2__["default"](todo.title, todo.description, '2022-03-25', todo.priority);
            } else {
              var splitDate = todo.dueDate.split('-');
              var formattedDate = "".concat(splitDate[2], "-").concat(splitDate[1], "-").concat(splitDate[0]);
              var tempTodo = new _todo__WEBPACK_IMPORTED_MODULE_2__["default"](todo.title, todo.description, formattedDate, todo.priority);
            }
    ...
    key: "getSaveState",
    value: function getSaveState(controller) {
      var todos = [];
      var projectNames = [];
      var projects = controller.getProjects();
      projects.forEach(function (project) {
        projectNames.push(project.getName());
        project.getTodos().forEach(function (projectTodo) {
          var todo = {
...
var projectController = /*#__PURE__*/function () {
  function projectController(name) {
  ...
  _createClass(projectController, [{
    ...
    key: "getProject",
    value: function getProject(name) {
      var toReturn = null;
    ...
    key: "removeTodo",
    value: function removeTodo(todo, project) {
    ...
    value: function sortTodos() {
      if (this.sortType === 'date') {
        this.todos.sort(function (a, b) {
          var result = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(a.getDueDateForInput()), (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(b.getDueDateForInput()));
          return result;
        });
...
var Todo = /*#__PURE__*/function () {
  ...
  _createClass(Todo, [{
    ...
    key: "getDueDateForSort",
    value: function getDueDateForSort() {
      return this.dueDate;
    }
  }, {
    key: "getDueDate",
    value: function getDueDate() {
      ...
      var dueDateDay = this.dueDate.split('-')[0];
      var dueDateMonth = this.dueDate.split('-')[1];
      var dueDateYear = this.dueDate.split('-')[2];
    ...
    key: "getDueDateForInput",
    value: function getDueDateForInput() {
      var dateSplit = this.dueDate.split('-');
      var toReturn = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dateSplit[2], dateSplit[1] - 1, dateSplit[0]), 'yyyy-MM-dd');
      return toReturn;
    }
  }, {
    key: "getPriority",
    ...
    value: function setDueDate(dueDate) {
      var dateSplit = dueDate.split('-');
      this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dateSplit[0], dateSplit[1] - 1, dateSplit[2]), 'dd-MM-yyyy');
      return this.dueDate;
    }
  }, {
    key: "setPriority",
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n    margin: 0;\n    background-color: rgb(247, 157, 73);\n    font-family: 'Lora';\n}\n\n.content{\n    width: 100vw;\n    height: 100vh;\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    grid-template-rows: 1fr 9fr;\n}\n\n.header, .header-fullscreen{\n    display: grid;\n    align-items: center;\n    grid-template-columns: 1fr 1fr 1fr;\n    background-color: rgb(122, 115, 115);\n}\n\n.header{\n    grid-column: 2/3;\n}\n\n.header-fullscreen{\n    grid-column: 1/3;\n}\n\n.header h1, .header-fullscreen h1{\n    color: white;\n    font-size: 48px;\n    text-align: center;\n}\n\n.navbar{\n    color: white;\n    font-size: 16px;\n    grid-row: 2/3;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: flex-start;\n}\n\n.navbar h2{\n    cursor: pointer;\n}\n\n.navbar h2:hover{\n    color: rgb(233, 231, 231);\n}\n\n.add-project-btn{\n    width: 200px;\n    color: white;\n    font-family: 'Lora';\n    font-size: 24px;\n    font-weight: 600;\n    margin: 25px;\n    padding: 8px;\n    border: none;\n    border-radius: 9px;\n    background-color: rgb(122, 115, 115);\n}\n\n.navbar button:hover{\n    background-color: rgb(158, 149, 149);\n    cursor: pointer;\n}\n\n.add-project-confirm{\n    font-family: 'Lora';\n    font-weight: 500;\n    font-size: 12px;\n    background-color: green;\n    border: none;\n    border-radius: 4px;\n}\n\n.add-project-cancel{\n    font-family: 'Lora';\n    font-weight: 500;\n    font-size: 12px;\n    background-color: red;\n    border: none;\n    border-radius: 4px;\n}\n\n.add-project{\n    display: flex;\n    \n}\n\n.add-project-error{\n    border: 2px solid red;\n}\n\n.header img, .header-fullscreen img{\n    width: 60px;\n    cursor: pointer;\n}\n\n.tasks, .tasks-fullscreen{\n    grid-row: 2/3;\n    background-color: white;\n}\n\n.tasks{\n    grid-column: 2/3;\n}\n\n.tasks h1, .tasks-fullscreen h1{\n    text-align: center;\n    text-decoration: underline;\n}\n\n.task-container{\n    border-radius: 6px;\n    padding-left: 30px;\n    padding-right: 30px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n.task-container:hover{\n    background-color: rgb(233, 231, 231);\n}\n\n.task-container input{\n    height: 25px;\n    width: 25px;\n    background-color: #eee;\n}\n\n.task-container-left{\n    display: flex;\n    gap: 10px;\n    justify-content: center;\n    align-items: center;\n}\n\n.task-container-right{\n    display: flex;\n    gap: 20px;\n    justify-content: center;\n    align-items: center;\n}\n\n.task-duedate{\n    text-align: center;\n    width: 100px;\n}\n\n.task-priority{\n    font-weight: bold;\n    text-align: center;\n    width: 80px;\n}\n\n.priority-high{\n    color: red;\n}\n\n.priority-medium{\n    color: orange;\n}\n\n.priority-low{\n    color: rgb(55, 172, 55);\n}\n\n.task-container-right img:hover{\n    transform: scale(1.2);\n    cursor: pointer;\n}\n\n.task-completed{\n    text-decoration: line-through;\n}\n\n.tasks-fullscreen{\n    grid-column: 1/3;\n}\n\n.task-add-btn{\n    width: 150px;\n    color: white;\n    font-family: 'Lora';\n    font-size: 18px;\n    font-weight: 600;\n    margin: 25px;\n    padding: 8px;\n    border: none;\n    border-radius: 9px;\n    background-color: rgb(122, 115, 115);\n}\n\n.task-add-btn:hover{\n    background-color: rgb(158, 149, 149);\n    cursor: pointer;\n}\n\n.toolbar{\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n}\n\n.add-todo-form{\n    margin: 40px;\n    font-size: 18px;\n    font-weight: 600;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    gap: 20px;\n}\n\n.add-todo-form input[type=text]{\n    font-family: 'Lora';\n    font-size: 16px;\n    width: 300px;\n    border: 1px solid black;\n}\n\n.add-todo-form input[type=date]{\n    border: 1px solid black;\n}\n\n.add-todo-form button{\n    border: none;\n    border-radius: 8px;\n    font-size: 18px;\n    font-weight: 600;\n    font-family: 'Lora';\n    padding: 6px;\n    width: 100px;\n}\n\n.add-todo-confirm{\n    background-color: green;\n    cursor: pointer;\n}\n\n.add-todo-cancel{\n    background-color: red;\n    cursor: pointer;\n}\n\n.add-todo-error{\n    border: 6px solid red;\n}\n\n.error-msg{\n    color: red;\n    text-align: center;\n}\n\n.edit-container{\n    position: fixed;\n    left: 37.5vw;\n    top: 25vh;\n    width: max(280px, 25vw);\n    height: max(300px, 30vh);\n    padding: 50px;\n    border: 4px solid black;\n    border-radius: 12px;\n    background-color: white;\n    text-align: center;\n}\n\n.edit-form{\n    display: grid;\n    gap: 10px;\n    grid-template-columns: 1fr 3fr;\n}\n\n.edit-container button{\n    border: none;\n    border-radius: 8px;\n    font-size: 12px;\n    font-weight: 600;\n    font-family: 'Lora';\n    padding: 6px;\n    margin: 30px;\n    width: 60px;\n}\n\n.edit-todo-confirm{\n    background-color: green;\n    cursor: pointer;\n}\n\n.edit-todo-cancel{\n    background-color: red;\n    cursor: pointer;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;IACI,SAAS;IACT,mCAAmC;IACnC,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,aAAa;IACb,8BAA8B;IAC9B,2BAA2B;AAC/B;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,kCAAkC;IAClC,oCAAoC;AACxC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,eAAe;IACf,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,2BAA2B;AAC/B;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,mBAAmB;IACnB,eAAe;IACf,gBAAgB;IAChB,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,oCAAoC;AACxC;;AAEA;IACI,oCAAoC;IACpC,eAAe;AACnB;;AAEA;IACI,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;IACf,uBAAuB;IACvB,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;IACf,qBAAqB;IACrB,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,aAAa;;AAEjB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,WAAW;IACX,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,kBAAkB;IAClB,0BAA0B;AAC9B;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,mBAAmB;IACnB,aAAa;IACb,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,oCAAoC;AACxC;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,SAAS;IACT,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,SAAS;IACT,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,YAAY;AAChB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,qBAAqB;IACrB,eAAe;AACnB;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,mBAAmB;IACnB,eAAe;IACf,gBAAgB;IAChB,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,oCAAoC;AACxC;;AAEA;IACI,oCAAoC;IACpC,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,eAAe;IACf,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB,aAAa;IACb,2BAA2B;IAC3B,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,mBAAmB;IACnB,eAAe;IACf,YAAY;IACZ,uBAAuB;AAC3B;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,gBAAgB;IAChB,mBAAmB;IACnB,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,uBAAuB;IACvB,eAAe;AACnB;;AAEA;IACI,qBAAqB;IACrB,eAAe;AACnB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,UAAU;IACV,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,SAAS;IACT,uBAAuB;IACvB,wBAAwB;IACxB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,uBAAuB;IACvB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,SAAS;IACT,8BAA8B;AAClC;;AAEA;IACI,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,gBAAgB;IAChB,mBAAmB;IACnB,YAAY;IACZ,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,uBAAuB;IACvB,eAAe;AACnB;;AAEA;IACI,qBAAqB;IACrB,eAAe;AACnB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap');\n\nbody{\n    margin: 0;\n    background-color: rgb(247, 157, 73);\n    font-family: 'Lora';\n}\n\n.content{\n    width: 100vw;\n    height: 100vh;\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    grid-template-rows: 1fr 9fr;\n}\n\n.header, .header-fullscreen{\n    display: grid;\n    align-items: center;\n    grid-template-columns: 1fr 1fr 1fr;\n    background-color: rgb(122, 115, 115);\n}\n\n.header{\n    grid-column: 2/3;\n}\n\n.header-fullscreen{\n    grid-column: 1/3;\n}\n\n.header h1, .header-fullscreen h1{\n    color: white;\n    font-size: 48px;\n    text-align: center;\n}\n\n.navbar{\n    color: white;\n    font-size: 16px;\n    grid-row: 2/3;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: flex-start;\n}\n\n.navbar h2{\n    cursor: pointer;\n}\n\n.navbar h2:hover{\n    color: rgb(233, 231, 231);\n}\n\n.add-project-btn{\n    width: 200px;\n    color: white;\n    font-family: 'Lora';\n    font-size: 24px;\n    font-weight: 600;\n    margin: 25px;\n    padding: 8px;\n    border: none;\n    border-radius: 9px;\n    background-color: rgb(122, 115, 115);\n}\n\n.navbar button:hover{\n    background-color: rgb(158, 149, 149);\n    cursor: pointer;\n}\n\n.add-project-confirm{\n    font-family: 'Lora';\n    font-weight: 500;\n    font-size: 12px;\n    background-color: green;\n    border: none;\n    border-radius: 4px;\n}\n\n.add-project-cancel{\n    font-family: 'Lora';\n    font-weight: 500;\n    font-size: 12px;\n    background-color: red;\n    border: none;\n    border-radius: 4px;\n}\n\n.add-project{\n    display: flex;\n    \n}\n\n.add-project-error{\n    border: 2px solid red;\n}\n\n.header img, .header-fullscreen img{\n    width: 60px;\n    cursor: pointer;\n}\n\n.tasks, .tasks-fullscreen{\n    grid-row: 2/3;\n    background-color: white;\n}\n\n.tasks{\n    grid-column: 2/3;\n}\n\n.tasks h1, .tasks-fullscreen h1{\n    text-align: center;\n    text-decoration: underline;\n}\n\n.task-container{\n    border-radius: 6px;\n    padding-left: 30px;\n    padding-right: 30px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n.task-container:hover{\n    background-color: rgb(233, 231, 231);\n}\n\n.task-container input{\n    height: 25px;\n    width: 25px;\n    background-color: #eee;\n}\n\n.task-container-left{\n    display: flex;\n    gap: 10px;\n    justify-content: center;\n    align-items: center;\n}\n\n.task-container-right{\n    display: flex;\n    gap: 20px;\n    justify-content: center;\n    align-items: center;\n}\n\n.task-duedate{\n    text-align: center;\n    width: 100px;\n}\n\n.task-priority{\n    font-weight: bold;\n    text-align: center;\n    width: 80px;\n}\n\n.priority-high{\n    color: red;\n}\n\n.priority-medium{\n    color: orange;\n}\n\n.priority-low{\n    color: rgb(55, 172, 55);\n}\n\n.task-container-right img:hover{\n    transform: scale(1.2);\n    cursor: pointer;\n}\n\n.task-completed{\n    text-decoration: line-through;\n}\n\n.tasks-fullscreen{\n    grid-column: 1/3;\n}\n\n.task-add-btn{\n    width: 150px;\n    color: white;\n    font-family: 'Lora';\n    font-size: 18px;\n    font-weight: 600;\n    margin: 25px;\n    padding: 8px;\n    border: none;\n    border-radius: 9px;\n    background-color: rgb(122, 115, 115);\n}\n\n.task-add-btn:hover{\n    background-color: rgb(158, 149, 149);\n    cursor: pointer;\n}\n\n.toolbar{\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n}\n\n.add-todo-form{\n    margin: 40px;\n    font-size: 18px;\n    font-weight: 600;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    gap: 20px;\n}\n\n.add-todo-form input[type=text]{\n    font-family: 'Lora';\n    font-size: 16px;\n    width: 300px;\n    border: 1px solid black;\n}\n\n.add-todo-form input[type=date]{\n    border: 1px solid black;\n}\n\n.add-todo-form button{\n    border: none;\n    border-radius: 8px;\n    font-size: 18px;\n    font-weight: 600;\n    font-family: 'Lora';\n    padding: 6px;\n    width: 100px;\n}\n\n.add-todo-confirm{\n    background-color: green;\n    cursor: pointer;\n}\n\n.add-todo-cancel{\n    background-color: red;\n    cursor: pointer;\n}\n\n.add-todo-error{\n    border: 6px solid red;\n}\n\n.error-msg{\n    color: red;\n    text-align: center;\n}\n\n.edit-container{\n    position: fixed;\n    left: 37.5vw;\n    top: 25vh;\n    width: max(280px, 25vw);\n    height: max(300px, 30vh);\n    padding: 50px;\n    border: 4px solid black;\n    border-radius: 12px;\n    background-color: white;\n    text-align: center;\n}\n\n.edit-form{\n    display: grid;\n    gap: 10px;\n    grid-template-columns: 1fr 3fr;\n}\n\n.edit-container button{\n    border: none;\n    border-radius: 8px;\n    font-size: 12px;\n    font-weight: 600;\n    font-family: 'Lora';\n    padding: 6px;\n    margin: 30px;\n    width: 60px;\n}\n\n.edit-todo-confirm{\n    background-color: green;\n    cursor: pointer;\n}\n\n.edit-todo-cancel{\n    background-color: red;\n    cursor: pointer;\n}"],"sourceRoot":""}]);
// Exports
